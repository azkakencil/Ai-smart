        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="mb-10 lg:hidden text-center">
              <span className="text-sm font-black text-gold tracking-[0.3em] uppercase">Smart Intelligence</span>
            </div>
            ...
            <div className="mb-10">
              ...
              <p className="text-sacred-white/40 font-medium leading-relaxed">
                {isLogin ? 'Silakan autentikasi identitas Anda untuk masuk ke dalam ekosistem kecerdasan Smart AI.' : 'Bangun jangkar aman Anda di dalam jaringan saraf Smart AI untuk mulai berevolusi.'}
              </p>
            </div>
